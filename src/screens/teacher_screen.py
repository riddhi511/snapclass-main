...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning("You hven't created any subjects yet, Please Create One to Begin!")
        return
...
def teacher_screen_register():
    ...
    with btnc1:
        if st.button('Register Now', icon=':material/passkey:',  width='stretch'):
            # st.write(f"DEBUG: username={teacher_username!r}, name={teacher_name!r}, pass={teacher_pass!r}, confirm={teacher_pass_confirm!r}")
